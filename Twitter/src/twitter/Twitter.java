...
public class Twitter {
    ...
    public static void main(String[] args) {
        ...
        ListaSimple seguidores = new ListaSimple();// se crean 3 ususarios para probar 
                ...
                switch (numero) {
                    ...
                    case 4:
                        ...
                        if (usuarioDestino != null) {// si el ususario existe 
                            ...
                            Post nuevoPost = new Post(mensajePost, usuarioDestino, fechaActual);// se crea un nuevo post
                    ...
                    case 5:
                        ...
                        if (usuarioa != null) {// de haberlo
                            ...
                            if (!pilaPosts.esVacia()) {// si hay algo en ese ndood // es un tipo de metodo recursivo
                                System.out.println("Posts de " + usuarioa.getName() + ":");//se muestran los post
                                pilaPosts.mostrarPilaConMensajes(); // se muestran los post 
                            } else {
                                System.out.println("El usuario no tiene posts.");// en caso de == null ser verdad se notifica 
                            }
                    ...
                    case 6:// en este caso 6 se almacenan los post del usuario y sus seguidoires en un array 
                        ...
                        if (usuarioConsulta != null) {// si es distinto a null 
                            ...
                            if (!allPosts.isEmpty()) {// si el array no esta vacio 
                                System.out.println("Posts de " + usuarioConsulta.getName() + " y usuarios seguidos:");// el feed del ususario 
                                for (Post post : allPosts) {// se recorren el array
                                    System.out.println(post);// se imprime
                                }
                            } else {// en caso de que no hayan post en el array 
                                System.out.println("No hay posts para mostrar.");// se notifica 
                            }
